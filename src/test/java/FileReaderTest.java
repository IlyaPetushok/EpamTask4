...
import by.petushokilya.reader.impl.CustomFileReaderImpl;
...
public class FileReaderTest {
    ...
    @Test
    public void readExistingNonemptyFileTest() throws TextParserException {
        CustomFileReader reader = new CustomFileReaderImpl();
        String actual = reader.readFile(pathToFile);
